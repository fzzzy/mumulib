...
ALL_ELEMENTS: list[str] = (
    MAIN_ROOT + DOCUMENT_METADATA + SECTIONING_ROOT + CONTENT_SECTIONING +
    TEXT_CONTENT + INLINE_TEXT_SEMANTICS + IMAGE_AND_MULTIMEDIA + EMBEDDED_CONTENT +
    SVG_AND_MATHML + SCRIPTING + DEMARCATING_EDITS + TABLE_CONTENT +
    FORMS + INTERACTIVE_ELEMENTS + WEB_COMPONENTS
)
